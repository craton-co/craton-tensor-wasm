...
- `tensor-wasm-snapshot` (T40): default snapshot envelope flipped from
  ...
  unified artifact store envelope; reads accept legacy v2/v3
  indefinitely. Operators who depend on the legacy v3 wire format
...
- `tensor-wasm-api` — body-limit middleware standardized on axum's
  ...
  had a 32 MiB default that silently undercut the documented 64 MiB
  cap). Documentation in `API.md` and the openapi schema aligned to
  the single value (`MAX_REQUEST_BODY_BYTES = 64 MiB`).
...
[Unreleased]: https://github.com/craton-co/craton-tensor-wasm/compare/v0.3.7...HEAD
[0.3.7]: https://github.com/craton-co/craton-tensor-wasm/releases/tag/v0.3.7
[0.3.6]: https://github.com/craton-co/craton-tensor-wasm/releases/tag/v0.3.6
[0.3.5]: https://github.com/craton-co/craton-tensor-wasm/releases/tag/v0.3.5
[0.3.4]: https://github.com/craton-co/craton-tensor-wasm/releases/tag/v0.3.4
[0.3.3]: https://github.com/craton-co/craton-tensor-wasm/releases/tag/v0.3.3
[0.3.2]: https://github.com/craton-co/craton-tensor-wasm/releases/tag/v0.3.2
[0.3.1]: https://github.com/craton-co/craton-tensor-wasm/releases/tag/v0.3.1
[0.3.0]: https://github.com/craton-co/craton-tensor-wasm/releases/tag/v0.3.0
