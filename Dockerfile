...
#
#   docker build --build-arg BACKEND=cust       -t tensor-wasm:0.3.3-cust       .
#   docker build --build-arg BACKEND=cudarc     -t tensor-wasm:0.3.3-cudarc     .
#   docker build --build-arg BACKEND=cuda-oxide -t tensor-wasm:0.3.3-cuda-oxide .
#   docker build                                -t tensor-wasm:0.3.3            .  # host-only (no CUDA)
#
...
#
# Registry status as of v0.3.3: the ghcr.io path is NOT yet
